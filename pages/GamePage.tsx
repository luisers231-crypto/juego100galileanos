...
const GamePage: React.FC<GamePageProps> = ({ onNavigateHome }) => {
  ...
  return (
    <div className="min-h-screen bg-slate-900 bg-gradient-to-br from-slate-900 to-blue-900/50 text-white p-4 flex flex-col items-center justify-start pt-8 sm:pt-4">
      <div className="w-full max-w-6xl text-left">
        <button 
          onClick={onNavigateHome} 
          className="mb-4 text-cyan-300 hover:text-cyan-100 transition-colors flex items-center gap-2 group"
        >
